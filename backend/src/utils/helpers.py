...
class MetricsLogger:
    ...
    def incr(self, key, amount=1):
        ...
        logger.info(
            {"metric": key, "value": self.get(key), "timestamp": _get_formatted_time()},
        )
    ...
    def set(self, key, value):
        ...
        logger.info({"metric": key, "value": value, "timestamp": _get_formatted_time()})
    ...
    def get(self, key):
        ...
        logger.info(
            {"metric": key, "value": value, "timestamp": _get_formatted_time()},
        )
