...
@patch("src.web_backend.web_backend_service.xmlrpc.client.ServerProxy")
@patch("src.web_backend.web_backend_service.CityDAO")
@patch("src.web_backend.web_backend_service.ConnectionDAO")
