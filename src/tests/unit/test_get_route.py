...
def mock_create_graph(_):
    ...
    """
    return {1: {2: 10}, 2: {1: 10, 3: 15}, 3: {2: 15}, 4: {}}
...
def test_get_route_valid_route(mocker):
    ...
    """
    mocker.patch(
        "src.navigation_service.navigation_service.create_graph",
        side_effect=mock_create_graph,
    )
    mocker.patch(
        "src.navigation_service.navigation_service.dijkstra", side_effect=mock_dijkstra
    )
...
def test_get_route_no_connection_between_cities(mocker):
    ...
    mocker.patch(
        "src.navigation_service.navigation_service.dijkstra",
